import { mainArray,storeInFire } from "./Firebase data.js";
import {dateFormat,warningPopUp,gtDropDown,changeMainArray} from "./Common script.js";

gtDropDown('edit-gt-select');

/*-----------GT drop down------------*/
document.querySelector(".edit-gt-select").addEventListener("change", ()=> {
    changeMainArray('edit-gt-select');
    document.querySelector('.render-selected').innerHTML = '';
})
/*----------------End--------------------------*/


document.querySelector('.initial-edit-button').onclick = ()=>{
    ...
    mainArray.forEach((object)=>{
        ...
        html += `
                <div class="rendered-main">
                    ...
                    <button class="main-edit-button " data-main-id = ${object.id}>Edit</button>
       ...
       const componentName = object.name;
        ...
        html += `
            <div class="rendered-sub">
                ...
                <button class="sub-edit-button " data-sub-id = ${object.id}>Edit</button>
    ...
    opArray.forEach((object)=>{
       const opName = object.name;
        ...
        html += `<div class="rendered-op">
                        ...
                        <button class="op-edit-button" data-op-id = ${object.id}>Edit</button>
...
function renderAfterChanges(myArray,changingIn,id){
    ...
    if(changingIn === 'main'){
        displayElement = document.querySelector('.render-selected');
        renderMainComponents(displayElement);
    }else if (changingIn === 'sub'){
